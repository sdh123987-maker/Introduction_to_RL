...
# Configuration
# ==========================================
LOG_FILE_1 = 'model_daytime/ocam_rl_log_daytime1.csv'  # File 1
LOG_FILE_2 = 'model_daytime/ocam_rl_log_daytime2.csv'  # File 2

LABEL_1 = "Run 1 (Daytime1)"
LABEL_2 = "Run 2 (Daytime2)"
...
ax3.axhline(y=119, color='gray', linestyle='--', linewidth=2, label='Target (119)')
ax3.axhline(y=29, color='red', linestyle=':', linewidth=2, label='HW Limit')
ax3.axhspan(0, 29, color='red', alpha=0.05)
